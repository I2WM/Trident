...
# 1
python hat/train.py -opt options/train/HAT/001xf25_train_HAT-L_SRx4_finetune_from_ImageNet_pretrain.yml

# inference
python hat/test.py -opt options/test/HAT/001xf25_test_HAT-L_SRx4_finetune_from_ImageNet_pretrain.yml
python hat/test.py -opt options/test/HAT/001xf25_test_HAT-L_SRx4_finetune_from_ImageNet_pretrain_th_tta.yml

# 2
python hat/train.py -opt options/train/HAT/002xf25_train_HAT-L_SRx4_finetune_from_196k.yml