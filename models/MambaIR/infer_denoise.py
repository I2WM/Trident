...
"""
python infer_denoise.py
"""


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--input', type=str, default='datasets/DIV2K/denoising_val_input', help='input test image folder')
    parser.add_argument('--output', type=str, default='results/infer/02denoise_050k', help='output folder')
    parser.add_argument(
        '--task',
        type=str,
    ...
    parser.add_argument(
        '--model_path',
        type=str,
        default='experiments/002_My_train_MambaIRv2_DIV2K_level50_hx/models/net_g_50000.pth')
